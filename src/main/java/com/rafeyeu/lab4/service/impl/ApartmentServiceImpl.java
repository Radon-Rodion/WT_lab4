package com.rafeyeu.lab4.service.impl;

import com.rafeyeu.lab4.dao.DaoFactory;
import com.rafeyeu.lab4.dao.description.ApartamentDao;
import com.rafeyeu.lab4.dao.description.UserOrderDao;
import com.rafeyeu.lab4.dao.impl.ApartamentDaoImpl;
import com.rafeyeu.lab4.dao.impl.UserOrderDaoImpl;
...
import com.rafeyeu.lab4.service.description.UserOrderService;
import com.rafeyeu.lab4.service.validator.Validator;
import com.rafeyeu.lab4.service.validator.ValidatorFactory;
...
public class ApartmentServiceImpl implements ApartmentService {
    ...
    public boolean addNewApartment(String status, String type, String StringNumberOfRooms,
        ...
        if(status==null || type==null || StringNumberOfBeds ==null ||
                StringApartmentNumber ==null || StringNumberOfRooms ==null || StringPrice ==null){
            return false;
        }
        ...
        Apartment apartment=buildApartment(status,type,numberOfRooms,apartamentNumber,numberOfBeds,price);
        try {
    ...
    private Apartment buildApartment(String status, String type, int numberOfRooms,
                                     int apartmentNumber, int numberOfBeds, double  price){
